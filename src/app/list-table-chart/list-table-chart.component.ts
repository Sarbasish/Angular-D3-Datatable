...
@Component({
  selector: 'app-list-table-chart',
  encapsulation: ViewEncapsulation.None,
  templateUrl: './list-table-chart.component.html',
  styleUrls: ['./list-table-chart.component.css']
})
export class ListTableChartComponent implements OnInit {
