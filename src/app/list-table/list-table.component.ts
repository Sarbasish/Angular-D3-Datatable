...
const ELEMENT_DATA: Element[] = [
  ...
  {  position: 11, name: 'Sodium',  weight: 22.9897, symbol: 'Na' , checked: false },
  {  position: 12, name: 'Magnesium',  weight: 24.305, symbol: 'Mg' , checked: false },
  {  position: 13, name: 'Aluminum',  weight: 26.9815, symbol: 'Al' , checked: false },
  {  position: 14, name: 'Silicon',  weight: 28.0855, symbol: 'Si' , checked: false },
  {  position: 15, name: 'Phosphorus',  weight: 30.9738, symbol: 'P' , checked: false },
  {  position: 16, name: 'Sulfur',  weight: 32.065, symbol: 'S' , checked: false },
  {  position: 17, name: 'Chlorine',  weight: 35.453, symbol: 'Cl' , checked: false },
  {  position: 18, name: 'Argon',  weight: 39.948, symbol: 'Ar' , checked: false },
  {  position: 19, name: 'Potassium',  weight: 39.0983, symbol: 'K' , checked: false },
  {  position: 20, name: 'Calcium',  weight: 40.078, symbol: 'Ca' , checked: false },
];
